...
function AdminDashboard() {
    ...
    return (
        <div>
            <ProductImageUpload imageFile={imageFile} setImageFile={setImageFile} uploadedImageUrl={uploadedImageUrl} setUploadedImageUrl={setUploadedImageUrl} imageLoadingState={imageLoadingState} setImageLoadingState={setImageLoadingState} isCustomStyling={true} />
                    ...
                    featureImageList && featureImageList.length > 0 ?
                        featureImageList.map((item) =>
                            <div className="relative">
                                <img className="w-full h-[300px] object-cover rounded-t-lg" src={item?.image} />
                            </div>
                        ) : null
                }
            </div>
